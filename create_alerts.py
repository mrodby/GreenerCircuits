...
def main():
    ...
    refrigerator = 11
    gc_database.create_alert(channum=refrigerator, greater=False, watts=50, minutes=60,
        start=time(8, 0, 0), end=time(20, 0, 0), message='')

    garage_refrigerator = 17
    gc_database.create_alert(channum=garage_refrigerator, greater=False, watts=50, minutes=60,
        start=time(8, 0, 0), end=time(20, 0, 0), message='')
