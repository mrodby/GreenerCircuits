...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
    ...
    <p>
      To implement this project I had to brush up on PHP, CSS, HTML, MySQL, Python, Linux system administration,
      and third party libraries such as Beautiful Soup. All of the HTML, CSS, and PHP is hand-crafted.
    </p>
    <p style="text-align: center">
    ...
    <p>
      Choose Usage from the menu bar above to see how usage has varied for each circuit over the past 24 hours.
    </p>
